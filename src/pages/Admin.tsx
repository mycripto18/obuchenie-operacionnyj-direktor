        ...
        <Tabs defaultValue="seo" className="space-y-6">
          <TabsList className="grid grid-cols-4 md:grid-cols-10 w-full">
            ...
            <TabsTrigger value="html" className="flex items-center gap-2">
              ...
              <span className="hidden sm:inline">SEO HTML</span>
            </TabsTrigger>
...
${urls.map(url => `  <url>
    ...
    <priority>${url.priority}</priority>
          ...
          {/* Static HTML Generator Tab - полностью статический HTML */}
          <TabsContent value="static">
            <StaticHtmlGenerator />
          </TabsContent>

          {/* SEO HTML Generator Tab - для совместимости/SEO noscript */}
