...
const AdminContent = () => {
  ...
  const handlePublish = () => {
    handleSave();
    // Генерируем полный JSON для content.json
    const fullContent = JSON.stringify(content, null, 2);
                  ...
                  <div className="space-y-6 py-4">
                    ...
                    <div className="space-y-3">
                      <h3 className="font-semibold flex items-center gap-2">
                        ...
                        Файл content.json скачан
                      </h3>
                      <p className="text-sm text-muted-foreground ml-8">
                        Файл <code className="bg-muted px-1 rounded">content.json</code> уже скачан автоматически. 
                        Если нет — нажмите кнопку ниже.
                      </p>
                      <div className="ml-8">
                        <Button variant="outline" size="sm" onClick={handlePublish}>
                          <Download className="w-4 h-4 mr-2" />
                          Скачать content.json ещё раз
                        </Button>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-sm text-muted-foreground ml-8">
                        Замените файл в папке <code className="bg-muted px-1 rounded">public/</code> вашего проекта:
                      </p>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="ml-8 space-y-2">
                        <p className="text-sm text-muted-foreground">Команды для обновления:</p>
                        <div className="bg-muted p-3 rounded-lg font-mono text-sm space-y-1">
                          <div className="flex items-center justify-between">
                            ...
                            <Button 
                              variant="ghost" 
                              size="sm"
                              onClick={() => copyToClipboard('git add public/content.json')}
                            >
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <Button 
                              variant="ghost" 
                              size="sm"
                              onClick={() => copyToClipboard('git commit -m "Update content"')}
                            >
                              <Copy className="w-3 h-3" />
                            </Button>
                          </div>
                          <div className="flex items-center justify-between">
                            ...
                            <Button 
                              variant="ghost" 
                              size="sm"
                              onClick={() => copyToClipboard('git push')}
                            >
                              <Copy className="w-3 h-3" />
                            </Button>
                          </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-sm text-muted-foreground ml-8">
                        После пуша в GitHub, Vercel автоматически соберёт и развернёт новую версию. 
                        Изменения появятся на всех устройствах (веб и мобильных).
                      </p>
                    </div>

                    {/* Совет */}
                    <div className="bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-lg p-4">
                      <h4 className="font-medium text-green-800 dark:text-green-200 mb-2">✅ Результат</h4>
                      <p className="text-sm text-green-700 dark:text-green-300">
                        После обновления <code className="bg-green-100 dark:bg-green-900 px-1 rounded">public/content.json</code> в репозитории, 
                        контент будет одинаковым на всех устройствах — и на компьютере, и на мобильном.
                      </p>
                    </div>
                  </div>
                </DialogContent>
