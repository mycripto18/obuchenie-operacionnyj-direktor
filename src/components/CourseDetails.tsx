...
export const CourseDetails = ({ coursesData }: CourseDetailsProps) => {
  ...
  return (
    <section className="py-4 md:py-6">
      <div className="container max-w-4xl mx-auto px-3 md:px-4 space-y-6 md:space-y-8">
          ...
          >
            ...
            <div className="p-4 md:p-5 space-y-4 md:space-y-5">
              ...
              <div className="flex justify-center">
                <a 
                  href={course.url} 
                  className="flex items-center justify-center gap-2 w-full md:w-auto px-8 py-3.5 md:py-2.5 bg-primary text-primary-foreground rounded-lg font-semibold hover:bg-primary/90 transition-all text-sm md:text-sm active:scale-[0.98]" 
                  target="_blank" 
                  rel="noopener noreferrer"
                >
