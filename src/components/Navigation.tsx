  ...
  return (
    ...
    >
      <div className="container max-w-4xl mx-auto px-3 md:px-4">
        <div className="flex items-center justify-center gap-2 sm:gap-6 h-11 md:h-12 flex-wrap">
            ...
            if (isAnchor || isExternalLink) {
              return (
                <a 
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-xs sm:text-sm font-medium text-primary-foreground/80 hover:text-primary-foreground hover:bg-white/10 rounded-md transition-colors"
                >
